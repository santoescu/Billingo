@props(['nameFrom', 'nameTo', 'label' => null, 'valueFrom' => null, 'valueTo' => null, 'allowOpenEnd' => false, 'floating' => false, 'align' => 'right'])
...
<div>
    ...
    <div class="relative" data-daterange {{ $allowOpenEnd ? 'data-daterange-allow-open-end' : '' }} {{ $floating ? 'data-daterange-floating' : '' }} data-daterange-align="{{ $align }}">
