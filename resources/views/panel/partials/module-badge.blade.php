@php
    $moduleBadgeColors = [
        ...
        'receiving' => 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
        'payroll' => 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300',
    ];
@endphp
