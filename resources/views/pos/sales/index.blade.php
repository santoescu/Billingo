                                ...
                                @forelse ($documentos as $documento)
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-end text-sm">
                                            <a href="{{ route('pos.sales.show', $documento->_id) }}" class="flex size-8 items-center justify-center rounded-full text-gray-400 hover:bg-gray-100 hover:text-accent focus:outline-hidden dark:text-neutral-400 dark:hover:bg-neutral-700 ms-auto" aria-label="{{ __('View') }}">
