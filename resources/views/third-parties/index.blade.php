        ...
        <script>
            (function () {
                ...
                window.openThirdPartyPanel = function (thirdParty) {
                    ...
                    setSelectValue('tp-identification_type', thirdParty?.identification_type);
